      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Статистика</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card" style="min-height:400px;">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-8">
                    <h5 class="title">Пройденые тесты</h5>
                  </div>
                </div>  
              </div>
              <div class="card-body">
                  <?php
                    ...
                    $sql = "select * from tests where teacher_id = $user_id and status_id = 2";
                    ...
                    if(mysqli_num_rows($result) > 0) {
                          ...
                          <div class="card" style="background:#ededed;">
                              <div class="card-body" onclick="submit(<?= $row['id'];?>,'<?php echo $row['name'];?>')">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4"> 
                                    <p style="text-align:right;">Дата - <?= $row["date"];?></p>
                                  </div>
                                </div>
                              </div>
                          </div>
                      ...
                      <div id="no-data">
                        <center>
                          ...
                          <center><h5>Нет данных</h5></center>
                        </center>
                      </div>
                      <?php
                    }
