      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Окно базовой настроики</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card" style="min-height:400px;">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-8">
                    <h5 class="title">Написание тестов</h5>
                  </div>
                  <div class="col-md-4">
                    <button class="btn btn-primary btn-block btn-round" onclick="redirect_to_new_test()" style="margin-top:0px;width:100px !important;float:right !important;">НОВЫЙ</button>
                  </div>
                </div>  
              </div>
              <div class="card-body">
                    ...
                    if(mysqli_num_rows($result) > 0) {
                      ...
                      <div id="no-data">
                        <center>
                          ...
                          <center><h5>Пока ничего нет!</h5></center>
                        </center>
                      </div>
                      <?php
                    }
