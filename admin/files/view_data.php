      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Просмотр данных</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card" style="min-height:400px;">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-8">
                    <h5 class="title">Данные по всем классам и учащимся</h5>
                  </div>
                  <div class="col-md-2">
                    <select id="options" name="options" class="btn-round" required style="width:100%;">
                        <option id="" selected="true" value="" disabled="disabled">Выберите класс</option>
                       
                    </select>
                  </div>
                  <div class="col-md-2">
                    <button onclick = 'populateTable()' class="btn btn-primary btn-block btn-round" style="margin-top:0px;width:100px !important;float:right !important; onclick='getStudentsFromClass()' ">НАЙТИ</button>    
                  </div>
                </div>  
              </div>
              <div class="card-body">
                <!-- <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> -->
                  ...
                  <thead>
                      <tr>
                          ...
                          <th data-field="rollno">Номер ученика</th>
                      </tr>
                  </thead>
              </table>
                <!-- </form> -->
