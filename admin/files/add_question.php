              ...
              <div class="card-body">
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Название теста</label>
                          <input type="text" class="form-control" name="title" placeholder="Название теста" required/>
                      </div>
                      <div class="form-group">
                        <label>Вариант  (A)</label>
                          <input type="text" class="form-control" name="op_a" placeholder="Вариант (A)" required/>
                      </div>
                      <div class="form-group">
                        <label>Вариант (B)</label>
                          <input type="text" class="form-control" name="op_b" placeholder="Вариант (B)" required/>
                      </div>
                      <div class="form-group">
                        <label>Вариант (C)</label>
                          <input type="text" class="form-control" name="op_c" placeholder="Вариант (C)" required/>
                      </div>
                      <div class="form-group">
                        <label>Вариант (D)</label>
                          <input type="text" class="form-control" name="op_d" placeholder="Вариант (D)" required/>
                      </div>
                      <div class="form-group">
                        <label>Првильный вариант (A/B/C/D)</label>
                          <input type="text" class="form-control" name="op_correct" placeholder="Правильный вариант" required/>
                      </div>
                      <div class="form-group">
                        <label>Очки</label>
                          <input type="text" class="form-control" name="score" placeholder="Очки" required/>
                      </div>
                    </div>
                  </div>
                  <div class="row center-element">
                    <div class="col-md-8">
                      <div class="form-group">
                        <button class="btn btn-primary btn-block btn-round">Добавить вопрос</button>
                      </div>
                    </div>
                  </div>
                </form>
