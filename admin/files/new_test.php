      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Базовая настройка теста</a>
          </div>
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Название теста</label>
                          <input type="text" class="form-control" name="test_name" placeholder="Название теста" required/>
                      </div>
                      <div class="form-group">
                        <label>Название предмета</label>
                          <input type="text" class="form-control" name="subject_name" placeholder="Название предмета" required/>
                      </div>
                      <div class="form-group">
                        <label>Дата теста</label>
                          <input type="date" class="form-control" name="test_date" placeholder="Дата теста" required/>
                      </div>
                      <div class="form-group">
                        <label>Общее количество вопросов</label>
                          <input type="number" class="form-control" name="total_questions" placeholder="Общее количество вопросов" required/>
                      </div>
                      <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <select id="options" name="test_status" class="btn-round" required style="width:100%;">
                                  <option selected="true" value="" disabled="disabled">Выбрать статус теста</option>
                                  <?php
                            ...
                            <div class="col-md-6">
                                <select id="options" name="test_class" class="btn-round" required style="width:100%;">
                                  <option selected="true" value="" disabled="disabled">Выбрать класс</option>
                                  <?php
                  ...
                  <div class="row center-element">
                    <div class="col-md-8">
                      <div class="form-group">
                        <button class="btn btn-primary btn-block btn-round">СОЗДАТЬ ТЕСТ</button>
                      </div>
                    </div>
                  </div>
                </form>
